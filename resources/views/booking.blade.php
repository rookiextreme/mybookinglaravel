    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-location.html"><i data-feather="location"></i><span class="menu-title text-truncate" data-i18n="location">Lokasi</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="calendar.php"><i data-feather="calendar"></i><span class="calendar" data-i18n="calendar">Calendar</span></a>
                </li>
